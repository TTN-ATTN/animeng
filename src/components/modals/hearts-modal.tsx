            ...
            <DialogContent className = "max-W-md">
                <DialogHeader>
                    ...
                    <DialogDescription className = "text-center text-base text-1.5xl">
                     Please update to pro for UNLIMITED HEARTS, or buy them more in the store!
                    </DialogDescription>
                </DialogHeader>
                <DialogHeader>
                    <DialogFooter className = "mb-4">
                        <div className = "flex flex-col gap-y-4 w-full">
                            ...
                            <Button variant = "primaryOutline" className = "w-full" size = "lg" onClick = {() => {close();router.push("/learning");}}> 
