...
export const SideBar = ({ className }: Props) => {
    return (
        <div className={cn("flex flex-col lg:w-[256px] min-h-screen lg:fixed left-0 top-0 px-4 border-r-2", className)}>
            {/* Logo Section */}
            <div className="hidden lg:flex pl-4 pt-8 items-center gap-x-3">
                <Image src="/mascot.svg" height={40} width={40} alt="mascot image" />
                <h1 className="lg:text-xl text-2xl font-extrabold text-green-600 tracking-wide">
